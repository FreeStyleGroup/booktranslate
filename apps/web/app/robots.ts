...
/* Что поисковикам можно, а что нет.
   ...
   входа. Страница приглашения тоже закрыта — на обоих языках: она
   открывается одноразовой ссылкой из письма. Вход и регистрация открыты —
   их ищут по названию продукта. */
    ...
    rules: [
      {
        userAgent: "*",
        allow: "/",
        disallow: ["/app/", "/api/", "/root/", "/join", "/en/join"],
      },
    ],
