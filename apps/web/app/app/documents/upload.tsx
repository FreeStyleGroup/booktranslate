...
// Что предлагать в окне выбора файла. PDF и XLIFF принимаются API, но
// пока не разбираются, поэтому и не предлагаются: файл, который примут и
// не смогут открыть, — обещание, которого мы не сдержим.
const ACCEPT = ".docx,.epub,.html,.htm,.md,.markdown,.txt";
